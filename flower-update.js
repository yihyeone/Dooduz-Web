...
window.SUPPLEMENTAL_FLOWERS=["비단 꽃부채","성란화의 언약","우주 토끼 여행","우주선 댕댕이","별빛 입맞춤 구름 양","쌍둥이자리·성수쌍영","피어나는 동심","구름빛 사절","서리구름마","화려한 서커스","별의 시간의 사도","곰 돛 구름배","분홍빛 생일잔치","핏빛 달의 피안화","별 연꽃 시간 고리","고택 성자","불꽃 솜털 국화","명월유향","보랏빛 밤의 성단","몬스테라","앵구다정","분홍 방울","진홍빛 백일초","금잔화 궁등","썬글로우 히페리쿰"];
