...
window.SUPPLEMENTAL_FLOWERS=["비단 꽃부채","성란화의 언약","우주 토끼 여행","우주선 댕댕이","별빛 입맞춤 구름 양","쌍둥이자리·성수쌍영","피어나는 동심","구름빛 사절","서리구름마","화려한 서커스","별의 시간의 사도","곰 돛 구름배","분홍빛 생일잔치","핏빛 달의 피안화","별 연꽃 시간 고리","고택 성자","불꽃 솜털 국화","명월유합","보랏빛 밤의 성단","몬스테라","앵구다정","분홍 방울","진홍빛 백일초","금잔화 궁등","썬글로우 히페리쿰"];
window.SUPPLEMENTAL_FLOWER_GRADES=Object.assign(window.SUPPLEMENTAL_FLOWER_GRADES||{},{"쌍둥이자리·성수쌍영":"UR","피어나는 동심":"UR","구름빛 사절":"UR","서리구름마":"UR","화려한 서커스":"UR","별의 시간의 사도":"UR","곰 돛 구름배":"SSR","분홍빛 생일잔치":"SSR","핏빛 달의 피안화":"SSR","별 연꽃 시간 고리":"SSR","고택 성자":"SR","불꽃 솜털 국화":"SR","명월유합":"SR","보랏빛 밤의 성단":"SR","몬스테라":"R","앵구다정":"R","분홍 방울":"R","진홍빛 백일초":"R","금잔화 궁등":"R","썬글로우 히페리쿰":"N"});
